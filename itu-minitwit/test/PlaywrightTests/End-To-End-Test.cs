...
public partial class EndToEnd : PageTest
{
    ...
    public async Task CanClickRegisterPublicTimeLine()
    {
        ...
        await Expect(Page.GetByRole(AriaRole.Heading, new() { Name = "Create a new account." }))
            .ToBeVisibleAsync();
    }
    ...
    public async Task CanClickLoginPublicTimeline()
    {
        ...
        await Expect(
                Page.GetByRole(AriaRole.Heading, new() { Name = "Use a local account to log in." })
            )
            .ToBeVisibleAsync();
    }
    ...
    public async Task CanSeeRegisterPage()
    {
        ...
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Register", Exact = true })
            .ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Create a new account." })
            .ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Use another service to" })
            .ClickAsync();
    ...
    public async Task ViewOtherUsersTimelineLoggedin()
    {
        ...
        await Expect(Page.GetByRole(AriaRole.Heading, new() { Name = "Wendell Ballan's Timeline" }))
            .ToBeVisibleAsync();
