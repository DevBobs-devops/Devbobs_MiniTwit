...
- Could not figure out why devbobs.tech was not working. Asked ClaudeAI and found it our ip http://209.38.230.113/, do work, so Nginx does work with our IP. But the DNS does not work.
