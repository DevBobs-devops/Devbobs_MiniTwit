...
parrallel: 
\begin{enumerate}
    \item \textbf{Code linter with Csharpier}: Checks the format of the code and reports. Does not automaticly apply the format. 
    \item \textbf{Dockerfile linter with Hadolint}: Checks the format of the Minitwit dockerfile. % WE SHOULD LINT MORE THAN ONLY THIS?
