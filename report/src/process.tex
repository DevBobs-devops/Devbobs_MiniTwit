...
\subsubsection{CI/CD}
The CI/CD workflow runs on a successful Build and Test workflow and push to main. It consists of the following steps that run sequentially:
\begin{enumerate}
...
The release workflow runs on a successful CI/CD run. It builds and zips
