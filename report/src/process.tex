...
\code{ubuntu-24.04}. The CI/CD pipeline runs on a push to main e.g. with a pull-request to main. 
...
Grafana then queries Prometheus, which display and visualise the data. 
