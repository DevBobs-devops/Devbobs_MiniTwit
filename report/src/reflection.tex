...
To enable a short feedback loop, we have tried to keep our work visible. 
...
An example of a issue in our project board can be seen here \url{https://github.com/DevBobs-devops/Devbobs_MiniTwit/pull/66}. \\

As the project grew it became harder to diagnose and understand why something failed.
With the monitoring and logging setup this became easier, as everything was collected in one place. 
