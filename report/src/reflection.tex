...
This project have shown how powerful it can be to bridge the gap between developer and operations.
...
This was done though the use of conventional commits, a developer notebook for progress and changes, a project board, and group chat for emergencies.
...
As a consequence of these problems with drilldown, we often had to check the logs on the server, by ssh into
